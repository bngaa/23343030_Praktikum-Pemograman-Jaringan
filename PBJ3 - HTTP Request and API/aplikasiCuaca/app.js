...
const url = 'http://api.weatherstack.com/current?access_key=dbba8e90d7a281c746c44bb942783e3b&query=-0.8969796661164124,100.3506470648109';
...
const geocodeURL = 
'https://api.mapbox.com/geocoding/v5/mapbox.places/Padang.json?access_token=pk.eyJ1IjoiYnVuZ2FhIiwiYSI6ImNtaDduNTI3eDBtcWoyaW9kMzRqcjBvNm4ifQ.U4V4eLS0qY2a56L8Gjm6_g&limit=3';
...
request({ url: geocodeURL, json: true }, (error, response) => {
  ...
  const weatherURL =
    `http://api.weatherstack.com/current?access_key=dbba8e90d7a281c746c44bb942783e3b&query=${latitude},${longitude}&units=m`
