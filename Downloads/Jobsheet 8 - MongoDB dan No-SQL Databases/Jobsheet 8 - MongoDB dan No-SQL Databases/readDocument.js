/**
 * File: readDocument.js
 * Deskripsi: Script untuk membaca/mencari dokumen dari database MongoDB
...
async function main() {
    try {
        ...
        const byNama = await db.collection('pengguna').findOne({ nama: "Bunga Aprillia" });
